package com.fengdis.generator.controller;
...
import com.fengdis.common.utils.security.PermissionUtils;
import com.fengdis.generator.domain.GenTable;
import com.fengdis.generator.domain.GenTableColumn;
import com.fengdis.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(@Validated GenTable genTable)
    {
    ...
    @ResponseBody
    public ResponseEntity<String> preview(@PathVariable("tableId") Long tableId) throws IOException
    {
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"fengdis.zip\"");
