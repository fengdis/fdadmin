...
import com.fengdis.common.base.Constant;
...
public class FileUtils {
    ...
    public static String fileUploadPath = PropertiesUtils.getString("file-upload.dir","");
    ...
    public static String upload(MultipartFile multipartFile,String uploadPath,String newName,boolean isWaterMark) {
        ...
        try {
            if(isWaterMark && ("png".equalsIgnoreCase(suffix) || "jpg".equalsIgnoreCase(suffix) || "jpeg".equalsIgnoreCase(suffix))){
                WaterMarkUtils.textWaterMark(multipartFile,uploadPath + newFileName,PropertiesUtils.getString("watermark.text",""));
            }else {
