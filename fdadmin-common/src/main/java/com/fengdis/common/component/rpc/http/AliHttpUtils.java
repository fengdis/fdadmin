package com.fengdis.common.component.rpc.http;
...
public class AliHttpUtils {
    ...
    private String parseResponse(HttpEntity responseEntity) throws IOException, UnsupportedEncodingException {
        String response = IOUtils.toString(new InputStreamReader(responseEntity.getContent(), "UTF-8"));
