...
public class SysMenuController extends BaseController
{
    ...
    @ResponseBody
    public ResponseEntity<String> remove(@PathVariable("menuId") Long menuId)
    {
    ...
    @PostMapping("/add")
    @ResponseBody
    public ResponseEntity<String> addSave(@Validated SysMenu menu)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(@Validated SysMenu menu)
    {
        if (UserConstants.MENU_NAME_NOT_UNIQUE.equals(menuService.checkMenuNameUnique(menu)))
        {
