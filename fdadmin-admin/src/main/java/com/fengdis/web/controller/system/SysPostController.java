...
import com.fengdis.system.service.ISysPostService;
...
public class SysPostController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public ResponseEntity<String> export(SysPost post)
    {
        List<SysPost> list = postService.selectPostList(post);
    ...
    @PostMapping("/add")
    @ResponseBody
    public ResponseEntity<String> addSave(@Validated SysPost post)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(@Validated SysPost post)
    {
        if (UserConstants.POST_NAME_NOT_UNIQUE.equals(postService.checkPostNameUnique(post)))
        {
