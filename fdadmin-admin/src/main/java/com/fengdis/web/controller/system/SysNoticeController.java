...
public class SysNoticeController extends BaseController
{
    ...
    @PostMapping("/add")
    @ResponseBody
    public ResponseEntity<String> addSave(SysNotice notice)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(SysNotice notice)
    {
    ...
    @PostMapping("/query")
    @ResponseBody
    public ResponseEntity<String> query(String noticeType)
    {
        return AjaxResult.success(noticeService.selectNoticeByType(noticeType));
    }
}
