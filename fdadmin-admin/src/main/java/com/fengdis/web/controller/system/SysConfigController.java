...
import com.fengdis.system.domain.SysConfig;
...
public class SysConfigController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public ResponseEntity<String> export(SysConfig config)
    {
        List<SysConfig> list = configService.selectConfigList(config);
    ...
    @PostMapping("/add")
    @ResponseBody
    public ResponseEntity<String> addSave(@Validated SysConfig config)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(@Validated SysConfig config)
    {
        if (UserConstants.CONFIG_KEY_NOT_UNIQUE.equals(configService.checkConfigKeyUnique(config)))
        {
