...
import com.fengdis.system.domain.SysDictType;
import com.fengdis.system.service.ISysDictTypeService;
...
public class SysDictTypeController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public ResponseEntity<String> export(SysDictType dictType)
    {
    ...
    @PostMapping("/add")
    @ResponseBody
    public ResponseEntity<String> addSave(@Validated SysDictType dict)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(@Validated SysDictType dict)
    {
        if (UserConstants.DICT_TYPE_NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict)))
        {
