...
import com.fengdis.common.utils.file.FileUploadUtils;
import com.fengdis.framework.shiro.service.SysPasswordService;
...
public class SysProfileController extends BaseController
{
    ...
    @ResponseBody
    public ResponseEntity<String> resetPwd(String oldPassword, String newPassword)
    {
        SysUser user = ShiroUtils.getSysUser();
    ...
    @PostMapping("/update")
    @ResponseBody
    public ResponseEntity<String> update(SysUser user)
    {
    ...
    @ResponseBody
    public ResponseEntity<String> updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        SysUser currentUser = ShiroUtils.getSysUser();
        try
        {
