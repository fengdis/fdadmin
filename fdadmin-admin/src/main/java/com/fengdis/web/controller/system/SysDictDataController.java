...
import com.fengdis.system.domain.SysDictData;
import com.fengdis.system.service.ISysDictDataService;
...
public class SysDictDataController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public ResponseEntity<String> export(SysDictData dictData)
    {
        List<SysDictData> list = dictDataService.selectDictDataList(dictData);
    ...
    @PostMapping("/add")
    @ResponseBody
    public ResponseEntity<String> addSave(@Validated SysDictData dict)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public ResponseEntity<String> editSave(@Validated SysDictData dict)
    {
