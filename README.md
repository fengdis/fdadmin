...
> 如需单应用，请移步 [fengdis-fast](https://gitee.com/y_project/fengdis-fast)  `(保持同步更新)`，如需其他版本，请移步 [项目扩展](http://doc.fengdis.vip/#/standard/xmkz)  `(不定时更新)`
...
演示地址：http://fengdis.vip  

文档地址：http://doc.fengdis.vip
