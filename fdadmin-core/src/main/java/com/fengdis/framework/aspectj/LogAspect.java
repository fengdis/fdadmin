package com.fengdis.framework.aspectj;
...
import com.fengdis.common.enums.BusinessStatus;
import com.fengdis.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.fengdis.common.annotation.Log)")
